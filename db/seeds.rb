...
User.create(user_name: "pickNgrin", email: "brad@email.com", password: "password", address: "1046 W Balmoral Ave, Chicago, IL 60640", bio: "I've been playing guitar since I was 16. Got into bluegrass around the same time. Favorite pickers are Doc Watson, Norman Blake, and Ricky Scaggs.", profile_image: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQTPWYY0DqOomG_0o0DOgvC6NQRjtzEjOL3JA&usqp=CAU")
User.create(user_name: "fiddle_sticks99", email: "mary@email.com", password: "password", address: "3128 N Clybourn Ave, Chicago, IL 60618", bio: "Hi, I'm Mary. I started playing violin in 2nd grade, and my dad turned me into a fiddle player with his love for bluegrass. I've been playing with groups since high school, and have played many festivals throughout the country. Check out my group, Lonesome Road here! www.youtube.com/lonesomeroadband", profile_image: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTjCAqOLzBrWV6U_vnKRuBvdP4nivqFX1zYbA&usqp=CAU")
User.create(user_name: "banjo_man18", email: "greg@email.com", password: "password", address: "3316 N Lincoln Ave, Chicago, IL 60657", bio: "Hey, I'm Greg. All my friends wanted to be cool and play guitar, so I decided to pick up the banjo just to be different. Maybe a bad idea? Haha. I've played Scruggs style for over 10 years. Recently started teaching myself clawhammer. 2 finger style, maybe someday...", profile_image: "https://thumbs.dreamstime.com/b/banjo-player-15221914.jpg")
User.create(user_name: "walley06", email: "mwalley@email.com", password: "password", address: "1822 N Milwaukee Ave, Chicago, IL 60647", bio: "I'm Matt. Friends call me Walley. I've played guitar for a few years but picked up mandolin and it's been my go-to. I used to play professionally in some touring groups, but now I just play around town for fun. Open to jam sessions or local gigs if you want some mando! Here's some links if you want to take a look/listen: www.youtube.com/mwalley, www.soundcloud.com/mwalley", profile_image: "https://thumbs.dreamstime.com/b/man-playing-mandolin-horizontal-against-white-background-33579946.jpg")
User.create(user_name: "res_sound_guy", email: "chris@email.com", password: "password", address: "3159 N Southport Ave, Chicago, IL 60657", bio: "Hey I'm Chris. I've been playing bass and piano since high school. I'll play pretty much any genre, but I love the folk community so I'm here for all the jams.", profile_image: "https://thumbs.dreamstime.com/z/upright-bass-musician-23791852.jpg")
User.create(user_name: "clayok", email: "clay@email.com", password: "password", address: "3509 W Fullerton Ave, Chicago, IL 60647", bio: "I've played guitar for a lot of rock stuff, but have been moving toward acoustic music. I'm new to bluegrass/folk so I'd love to jump in and start learning.", profile_image: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQoFECGlEmMz8YCtx2PRGtkUvfYcEgdX0wNeA&usqp=CAU")
User.create(user_name: "Graddy", email: "jgraddy@email.com", password: "password", address: "7212 N Clark St, Chicago, IL 60626", bio: "I'm Jeremy (usually go by Graddy). I'm a guitar player, but started learning pedal steel and dobro. Looking to jam with others and improve my skills!", profile_image: "https://images.pexels.com/photos/5045942/pexels-photo-5045942.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500")
...
InstrumentPost.create(post_id: 1, instrument_id: 1)
InstrumentPost.create(post_id: 2, instrument_id: 5)
InstrumentPost.create(post_id: 3, instrument_id: 1)
InstrumentPost.create(post_id: 3, instrument_id: 2)
InstrumentPost.create(post_id: 3, instrument_id: 3)
InstrumentPost.create(post_id: 3, instrument_id: 4)
InstrumentPost.create(post_id: 3, instrument_id: 5)
InstrumentPost.create(post_id: 3, instrument_id: 6)
InstrumentPost.create(post_id: 3, instrument_id: 7)
InstrumentPost.create(post_id: 3, instrument_id: 8)
InstrumentPost.create(post_id: 3, instrument_id: 9)
InstrumentPost.create(post_id: 4, instrument_id: 6)
